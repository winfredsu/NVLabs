    ...
    ([] as any[]),(_l:any) => {
      return i0.ɵmod([i0.ɵmpd(512,i0.ComponentFactoryResolver,i0.ɵCodegenComponentFactoryResolver,
          [[8,[i2.HomeComponentNgFactory,i3.PlatformComponentNgFactory,i3.PlatformOverviewComponentNgFactory,
              ...
              i4.SimulatorConceptAndStructureComponentNgFactory,i4.SimulatorExampleComponentNgFactory,
          ...
          i0.ɵmpd(1024,i9.ROUTES,() => {
            return [[{path:'home',component:i11.HomeComponent},{path:'platform',component:i12.PlatformComponent,
                children:[{path:'',redirectTo:'overview',pathMatch:'full'},{path:'overview',
                    component:i12.PlatformOverviewComponent},{path:'getting-started',
                    component:i12.PlatformGettingStartedComponent},{path:'techspecs',
                    component:i12.PlatformTechspecsComponent},{path:'downloads',component:i12.PlatformDownloadsComponent}]},
                {path:'simulator',component:i13.SimulatorComponent,children:[{path:'',
                    redirectTo:'overview',pathMatch:'full'},{path:'overview',component:i13.SimulatorOverviewComponent},
